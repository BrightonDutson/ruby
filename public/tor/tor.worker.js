(() => {
    "use strict";
    importScripts("/tor/tor.bundle.js?1"), importScripts("/tor/tor.config.js?1"), self.TorServiceWorker = class {
        constructor() {
            this.config = self.__tor$config, this.bundle = self.__tor$bundle, this.bareClient = new this.bundle.BareClient(this.config.bare)
        }
        fetch(t) {
            return s = this, i = void 0, r = function*() {
                ...
                if (this.config.blacklist && this.config.blacklist.some((e => e.test(i.host)))) return new e;
                const r = {
                ...
                switch (!0) {
                    case /text\/html/.test(l):
                        ...
                        } else A = `<head>\n            <script src="${this.config.files.bundle}"><\/script>\n            <script src="${this.config.files.config}"><\/script>\n            <script src="${this.config.files.client}"><\/script>\n            <link rel="icon" href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAA1JREFUGFdjYGBkZAAAAAoAAx9k7/gAAAAASUVORK5CYIIA">\n            <link rel="icon" href="${i.origin}/favicon.ico">\n            ${301===o&&a.location?`<meta http-equiv="refresh" content="0; url=${this.bundle.rewrite.url.rewriteURL(a.location)}">`:""}\n          </head>`, A += this.bundle.rewrite.html(e, s);
                        break;
...
//# sourceMappingURL=tor.worker.js.map
